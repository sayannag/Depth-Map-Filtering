...
//}
    ...
    input1=cvLoadImage("a1.jpg",1);   
    cvNamedWindow("ii",1); 
    cvShowImage("ii",input1); 
    
    input2=cvLoadImage("a2.jpg",1);   
    cvNamedWindow("jj",1); 
